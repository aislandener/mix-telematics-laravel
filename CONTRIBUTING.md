...
to [aislandenersouzavicentini@gmail.com](mailto:aislandenersouzavicentini@gmail.com).
...
* Consider starting the commit message with an applicable emoji:
    ...
    * :construction: `:construction:` when in WIP (Work in Progress) in function or class
    * :rocket: `:rocket:` when in release version
